...
export const careerPillars: CareerBridgePillar[] = [
  {
    ...
    actionPrompt: 'Inventarisasi tools apa saja yang membuatmu makin mandiri mengeksekusi tugas.'
  },
  {
    ...
    actionPrompt: 'Kumpulkan metrik pencapaian selagi datanya masih segar di ingatan.'
  },
  {
    id: 'pillar-projects',
    ...
    actionPrompt: 'Bahan terbaik saat performance review atau pembaruan CV di masa depan.'
  },
  {
    id: 'pillar-training',
    ...
    actionPrompt: 'Menjaga rekam jejak continuous learning secara rapi.'
  },
  {
    ...
    actionPrompt: 'Membantu diskusi 1-on-1 dengan atasan jadi lebih terarah dan konstruktif.'
  },
  {
    id: 'pillar-evaluasi',
    ...
    actionPrompt: 'Menghindari burnout dengan menyadari progres nyata yang sudah kamu tempuh.'
  }
];
